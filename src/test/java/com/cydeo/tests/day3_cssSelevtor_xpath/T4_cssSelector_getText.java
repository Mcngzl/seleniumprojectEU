...
public class T4_cssSelector_getText {
    public static void main(String[] args) {
        ...
        String expectedRestPasswordButtonText ="Reset password";
        String actualResetPaswordButtonText = resetpasswordbutton.getText();

        if (actualResetPaswordButtonText.equals(expectedRestPasswordButtonText)){
